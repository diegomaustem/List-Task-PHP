...
<html>
	<head>
		...
		<script>
			function update(id, textoTarefa){
			...
			function check(id){
				location.href = 'index.php?pag=index&acao=checkOn&id='+id;
			}
		</script>
	</head>
					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								...
								<hr />
								<?php foreach ($listTarefasPendentes as $indice => $tarefa) { ?>
									<div class="row mb-3 d-flex align-items-center tarefa">
										...
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											...
											<i class="fas fa-edit fa-lg text-info" onclick="update(<?= $tarefa->id ?>, '<?= $tarefa->tarefa ?>')"></i>
